...
const search = async (type) => {
  ...
  return (
    <div className="App">
      ...
      <div className='about'>
      <p className='about-text'>WPM is the leading property maintenance contractor in the Wellsbury area and having been established for over 40 years, we have expertise in a range of different areas. No job is tool small or too big, just call our office and our team will be happy to guide you through the process from the initial free quote up to completion.</p>
